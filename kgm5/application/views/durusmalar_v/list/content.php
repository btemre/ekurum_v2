...
$defaultPageLength=($mainModuleCustom=="dashboard")?10:25;
...
if ($DurusmalarimActive) {
    ...
    $moduleTitle=($moduleName=="dashboard")?"Bugün Olan Duruşmaların Listesi":"Tüm Duruşmalar";
    $moduleSubTitle=($moduleName=="dashboard")?"Anasayfa":"Duruşmalar";    
    $dateStart=($moduleName=="dashboard")?date("d-m-Y H:i"):"";    
    $dateEnd=($moduleName=="dashboard")?$dateStart:"";    
}
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <?php if (isset($moduleName) && $moduleName === 'dashboard' && isAllowedViewApp("edts")) {
            ...
            $hasAny = (!empty($reminders) || $lastNote);
        ?>
        <!--begin::Not Defteri / Hatırlatmalar widget-->
        <div class="row g-5 g-xl-10 mb-4">
            <div class="col-12">
                <div class="card card-bordered">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-dark"><i class="bi bi-journal-text me-2"></i>Not Defteri / Hatırlatmalar</span>
                        </h3>
                    ...
                    <div class="card-body pt-2 pb-4">
                        <?php if (!$hasAny) { ?>
                            <p class="text-gray-600 mb-0">Henüz not veya hatırlatma yok. <a href="<?php echo base_url('notesreminders'); ?>">Not Defteri</a> sayfasından ekleyebilirsiniz.</p>
                        <?php } else { ?>
                            <?php if (!empty($reminders)) { ?>
                                <div class="mb-4">
                                    <span class="fw-bold text-gray-700 d-block mb-2"><i class="bi bi-bell me-1"></i>Yaklaşan hatırlatmalar</span>
                            ...
                            ?>
                                <div>
                                    <span class="fw-bold text-gray-700 d-block mb-2"><i class="bi bi-journal me-1"></i>Son not</span>
                                    <div class="bg-light rounded p-3">
                                        <div class="fw-bold text-dark"><?php echo htmlspecialchars($lastNote->n_title); ?> <?php echo getNoteTagBadge($lastNote->n_tag ?? ''); ?></div>
        ...
        <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 mb-md-5 mb-xl-10">
                ...
                <div class="card px-2">
                    <!--begin::Card header-->
                    <div class="card-header border-0 pt-1 px-3 d-flex flex-column">
                        <!--begin::Satır 1: AI Asistan (premium)-->
                        <div id="dashboard_ai_asistan_row" class="ai-asistan-premium d-flex align-items-center flex-wrap gap-3 py-4 px-4 mb-3 w-100">
                            ...
                            <button type="button" class="btn btn-sm btn-light-primary fw-bold shrink-0 ai-asistan-btn" id="ai_capacity_forecast_btn" onclick="AiService.requestCapacityForecast(true)">
                                <i class="bi bi-arrow-repeat me-1"></i>Başka
                            </button>
                        </div>
                        <!--end::Satır 1-->
                        <!--begin::Satır 2: Arama alanı ve butonlar-->
                ...
                <!--end::Card-->
                        ...
                        <?php if ($mainModuleCustom != "dashboard"): ?>
