  ...
  <div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12">
    ...
    <div class="bg-body d-flex flex-center rounded-4 w-md-600px p-10">
      ...
      <div class="w-md-400px">
        <!--begin::Form-->
        <form method="POST" class="form w-100" novalidate="novalidate" id="kt_new_passwordmail_form" data-kt-redirect-url="" action="<?php echo base_url('auth/repasswordmail'); ?>">
          <!--begin::Heading-->
          ...
          <div class="fv-row mb-8">
            ...
            <input type="text" placeholder="Doğrulama Kodu" name="kodmail" id="kodmail" autocomplete="off" class="form-control bg-transparent" />
            <!--end::Repeat Password-->
            <?php if (isset($form_error)) { ?>
              <div class="fv-plugins-message-container invalid-feedback">
                <div data-field="kodmail"><?php echo @form_error("kodmail"); ?></div>
              </div>
            <?php } ?>
          </div>
          <!--begin::Input group-->
          <div class="fv-row mb-8" data-kt-password-meter="false">
            ...
            <div class="mb-1">
              ...
              <div class="position-relative mb-3">
                <input class="form-control bg-transparent" type="passwordmail" placeholder="Yeni Parola" name="passwordmail" id="passwordmail" autocomplete="off" />
              ...
              <?php if (isset($form_error)) { ?>
                <div class="fv-plugins-message-container invalid-feedback">
                  <div data-field="passwordmail"><?php echo @form_error("passwordmail"); ?></div>
                </div>
              <?php } ?>
            </div>
            <!--end::Wrapper-->
            <!--begin::Hint-->
            <div class="text-muted">12 Karakter olarak kullanabilirsiniz</div>
            <!--end::Hint-->
          </div>
          <!--end::Input group=-->
          <!--end::Input group=-->
          <div class="fv-row mb-8">
            <!--begin::Repeat Password-->
            <input type="password" placeholder="Parola Tekrar" name="repasswordmail" id="repasswordmail" autocomplete="off" class="form-control bg-transparent" />
            <!--end::Repeat Password-->
            <?php if (isset($form_error)) { ?>
              <div class="fv-plugins-message-container invalid-feedback">
                <div data-field="repasswordmail"><?php echo @form_error("repasswordmail"); ?></div>
              </div>
            <?php } ?>
          </div>
          <!--end::Input group=-->
          ...
          <div class="d-grid mb-10">
            <button type="button" id="kt_new_passwordmail_submit" class="btn btn-primary">
