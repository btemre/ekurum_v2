  ...
  <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed">
    ...
    <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
      ...
      <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
        ...
        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="<?php echo base_url('auth/do_login'); ?>" method="POST" data-kt-redirect-url="<?php echo base_url(); ?>" action="#">
          ...
          <div class="text-center mb-10">
            ...
            <h1 class="text-muted fs-6 mb-5">Uygulama Kapısı</h1>
            <!--end::Title-->
          </div>
          ...
          <div class="form-floating fv-row mb-10">
            ...
            <!--end::Label-->
            <!--begin::Input-->
            <input class="form-control form-control-lg" type="text" name="username" id="username" autocomplete="off" />
            <label for="floatingInput" class="fw-bolder fs-3">Kullanıcı Adı</label>
          ...
          <div class="form-floating fv-row mb-10">
            ...
            <label for="floatingInput" class="fw-bolder fs-3">Parola</label>
            <?php if (isset($form_error)) { ?>
              <div class="fv-plugins-message-container invalid-feedback">
      ...
      <div class="d-flex align-items-center fw-bold fs-6 p-2">
        <a href="<?php echo base_url('auth/forgotpassword'); ?>" class="text-muted text-hover-primary px-2">Parolamı Unuttum</a>
      </div>
      <!--end::Links-->
    ...
    <div class="d-flex flex-center flex-column-auto p-10">
      ...
      <div class="d-flex align-items-center fw-bold fs-6">
        ...
        <a href="https://ekurum.hipporello.net/desk" target=_blank class="text-muted text-hover-primary px-2">Yardım Masası</a>
