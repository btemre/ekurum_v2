...
<style>
#yz_ekurum_chat_page { display: flex; flex-direction: column; height: calc(100vh - 120px); min-height: 400px; }
#yz_ekurum_chat_layout { display: flex; flex: 1; min-height: 0; }
#yz_ekurum_sessions_col { width: 240px; min-width: 200px; border-right: 1px solid var(--bs-border-color); display: flex; flex-direction: column; background: var(--bs-body-bg); }
#yz_ekurum_sessions_list { overflow-y: auto; flex: 1; padding: 0.5rem 0; }
#yz_ekurum_chat_col { flex: 1; display: flex; flex-direction: column; min-width: 0; }
#yz_ekurum_messages { flex: 1; overflow-y: auto; padding: 1rem; }
#yz_ekurum_input_area { padding: 0.75rem 1rem; border-top: 1px solid var(--bs-border-color); background: var(--bs-body-bg); }
