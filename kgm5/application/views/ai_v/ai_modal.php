    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer bg-light">
                ...
                <button type="button" class="btn btn-light-warning me-2" id="ai_refresh_week_btn" onclick="aiRefreshWeekSummary()" title="Yeni özet oluştur" style="display:none;">
                    <i class="bi bi-arrow-clockwise me-1"></i>Özeti Yenile
                </button>
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text" class="form-control border-info" id="ai_search_input"
                            placeholder="Örn: Son 30 günde hangi avukat en çok duruşmaya girdi?"
                            maxlength="500"
                    ...
                    <div class="form-text text-muted mt-2">
                        ...
                        Örnek sorular: "24 Şubat salı günü kaç mahkeme var?", "DAVALI tarafında en çok hangi mahkemede duruşma var?", "Bu ay karar verilen duruşmalar"
                    </div>
                </div>
                <!--end::Search Input-->
