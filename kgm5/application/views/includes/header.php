                                ...
                                <div class="mh-450px scroll-y me-n5 pe-5">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        ?>
                                                    <!--begin::Col-->
                                                    <div class="col-4">
                                                        <a href="<?php echo base_url('apps/' . $app->a_appcode . '/'); ?>" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                            <img src="<?php echo base_url('apps/' . $app->a_appcode . '/' . $appJson->image); ?>" class="w-25px h-25px mb-2" alt="" />
