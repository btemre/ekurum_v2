    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-6 mb-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-500">Kullanıcı Grupları</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->

            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Grup Listesi</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
        <!--begin::Actions-->
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <a href="<?php echo base_url("appsettings/grouplist/{$item->a_appcode}"); ?>" class="btn btn-sm btn-primary">
                    ...
                    <div class="card-header border-0 pt-1">
                        ...
                        <div class="card-title">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-dark">Yetkilendirilecek Kullanıcı Grupları</span>
                                <span class="text-muted mt-1 fw-bold fs-7">Uygulama Modüllerinin Kullanıcı Gruplarıyla İlgili Yetkilerin Düzenlemesini Yapabilirsiniz.</span>
                            </h3>
                        </div>
                        <!--begin::Card title-->
                        <!--begin::Card toolbar-->
                        ...
                        <?php if (empty($groupList)) { ?>
                            ...
                            <div class="alert alert-primary d-flex align-items-center p-5 mb-10">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span>Yetkilendirebileceğiniz herhangi bir kullanıcı grubu kaydı bulunamadı.</span>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <?php if (isDbAllowedUpdateModule() && isDbAdminViewModule()) { ?>
                                                        <a href="<?php echo base_url("appsettings/group_permissions/{$item->a_appcode}/{$group->ug_id}"); ?>" class="btn btn-sm btn-light-warning text-gray-900 mt-0 mt-md-0"><i class="la la-eye fs-3"></i> Modül Yetkileri</a>
                                                    <?php } ?>
                                                    <!--end::Menu-->
                                                </td>
                                                <!--end::Action=-->
