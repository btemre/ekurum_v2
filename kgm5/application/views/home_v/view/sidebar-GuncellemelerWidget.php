    ...
    <div class="d-flex align-items-stretch flex-shrink-0">
      ...
      <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
          <img src="<?php echo base_url('assets/media/avatars/blank.jpg');?>" alt="user" />
        </div>
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
          ...
          <div class="menu-item px-3">
            <div class="menu-content d-flex align-items-center px-3">
              ...
              <div class="symbol symbol-50px me-5">
                <img alt="Hoşgeldiniz!" src="<?php echo base_url('assets/media/avatars/blank.jpg');?>" />
              </div>
              <!--end::Avatar-->
              <!--begin::Username-->
              <div class="d-flex flex-column">
                <div class="fw-bolder d-flex align-items-center fs-5"><?php echo @$userData->userB->u_name.' '.$userData->userB->u_lastname.' '.$userData->userB->u_surname; ?>
                  <span class="badge badge-light-<?php echo @$userData->userB->ug_color;?> fw-bolder fs-8 px-2 py-1 ms-2" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo $userData->userB->ug_name;?>"><?php echo $userData->userB->ug_code;?></span></div>
          ...
          <!--begin::Menu item-->
          <div class="menu-item px-5 my-1">
            <a href="https://ekurum.hipporello.net/desk" class="menu-link px-5" target=_blank>Destek Bildirimi</a>
          </div>
          <!--end::Menu item-->
          <!--begin::Menu separator-->
          <div class="separator my-2"></div>
...
<path d="M13 2.5a1.5 1.5 0 0 1 3 0v11a1.5 1.5 0 0 1-3 0v-.214c-2.162-1.241-4.49-1.843-6.912-2.083l.405 2.712A1 1 0 0 1 5.51 15.1h-.548a1 1 0 0 1-.916-.599l-1.85-3.49a68.14 68.14 0 0 0-.202-.003A2.014 2.014 0 0 1 0 9V7a2.02 2.02 0 0 1 1.992-2.013 74.663 74.663 0 0 0 2.483-.075c3.043-.154 6.148-.849 8.525-2.199V2.5zm1 0v11a.5.5 0 0 0 1 0v-11a.5.5 0 0 0-1 0zm-1 1.35c-2.344 1.205-5.209 1.842-8 2.033v4.233c.18.01.359.022.537.036 2.568.189 5.093.744 7.463 1.993V3.85zm-9 6.215v-4.13a95.09 95.09 0 0 1-1.992.052A1.02 1.02 0 0 0 1 7v2c0 .55.448 1.002 1.006 1.009A60.49 60.49 0 0 1 4 10.065zm-.657.975 1.609 3.037.01.024h.548l-.002-.014-.443-2.966a68.019 68.019 0 0 0-1.722-.082z"/>
          ...
          <div class="timeline-content mb-10 mt-n1">
            ...
            <div class="mb-5 pe-3">
              <!--begin::Title-->
              <a href="#" class="fs-5 fw-bold text-white text-hover-success mb-2">Hukuk - Döküman Yönetim Sistemi</a>
              <!--end::Title-->
              <!--begin::Description-->
              <div class="d-flex align-items-center mt-1 fs-6">
                <!--begin::Info-->
                <div class="text-white opacity-50 me-2 fs-7">17:50 </div>
                <!--end::Info-->
                <!--begin::User-->
                <a href="#" class="text-success fs-7 fw-bolder">Sistem İyileştirmesi</a>
                <!--end::User-->
              </div>
              <!--end::Description-->
            </div>
...
<path fill-rule="evenodd" d="M0 .5A.5.5 0 0 1 .5 0h4a.5.5 0 0 1 0 1h-4A.5.5 0 0 1 0 .5Zm0 2A.5.5 0 0 1 .5 2h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5Zm9 0a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Zm-9 2A.5.5 0 0 1 .5 4h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5Zm5 0a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Zm7 0a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5Zm-12 2A.5.5 0 0 1 .5 6h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5Zm8 0a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Zm-8 2A.5.5 0 0 1 .5 8h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Zm7 0a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5Zm-7 2a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 0 1h-8a.5.5 0 0 1-.5-.5Zm0 2a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5Zm0 2a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Z"/>
                  ...
                  <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-column me-2">
                      <!--begin::Desc-->
                      <a href="#" class="fs-7 text-white text-hover-success fw-bolder">Detaylı Rapor</a>
                      <!--end::Desc-->
                      <!--begin::Number-->
                      <div class="text-gray-400">Versiyon 1.3.7</div>
                      <!--end::Number-->
                    </div>
                    <!--end::Info-->
                  </div>
                ...
                <!--end::Wrapper-->
                <!--begin::Action-->
                <a href="#" class="btn btn-sm btn-hover-rise text-white bg-white bg-opacity-10">Göster</a>
                <!--end::Action-->
              </div>
              <!--end::Item-->
            </div>
...
<path fill-rule="evenodd" d="M0 .5A.5.5 0 0 1 .5 0h4a.5.5 0 0 1 0 1h-4A.5.5 0 0 1 0 .5Zm0 2A.5.5 0 0 1 .5 2h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5Zm9 0a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Zm-9 2A.5.5 0 0 1 .5 4h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5Zm5 0a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Zm7 0a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5Zm-12 2A.5.5 0 0 1 .5 6h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5Zm8 0a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Zm-8 2A.5.5 0 0 1 .5 8h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Zm7 0a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5Zm-7 2a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 0 1h-8a.5.5 0 0 1-.5-.5Zm0 2a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5Zm0 2a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Z"/>
  ...
  <div class="text-center" id="kt_sidebar_footer">
    <!--begin::Link-->
    <a href="#" class="btn btn-hover-rise text-white bg-white bg-opacity-10 text-uppercase fs-7 fw-bolder">Duyurular</a>
    <!--end::Link-->
  </div>
  <!--end::Footer-->
</div>
