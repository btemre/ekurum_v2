...
function xlsTagYazdir($item = false)
{
    //return $item;
    $t = &get_instance();
...
function xlsEditTagYazdir($item = false)
{
    //return $item;
    $t = &get_instance();
    $t->load->model("durusmalar_model");
...
function xlsAyracsizYazdir($item = false)
{
    $_text = "";
    if ($item != false) {
        $_texts = @explode("@", $item);
...
function xlsEditAyracliYazdir($item = false)
{
    $_text = "";
    if ($item != false) {
        $_texts = @explode("@", $item);
...
function xlsTagifyToText($data = false)
{
    $_text = "";
    if (is_array($data)) {
...
function xlsTagifyToTextToUpper($data = false)
{
    $_text = "";
...
function xlsTakipBilgisiYaz($id=false){
    $_tur = "Bilinmiyor";
    switch ($id) {
        case false:
            $_tur = "";
...
function xlsTutanakBilgisiYaz($id=false){
    $_tur = "Bilinmiyor";
    switch ($id) {
        case false:
            $_tur = "";
...
function xlsSorumluAvukatCek($id=false){
    $t = &get_instance();
    $items = false;
    if($id!==false){
        $t->load->model("durusmalar_model");
