...
defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    ### <begin::Controller Ic Yetkilendirme Kontrol Fonksiyonları> ###
        ...
        function isDbAllowedViewModule($moduleName=""){
            ...
            $isStatusAdminPermissions = $t->userstatus_model->ek_get(
    ...
    ### <begin::Ana Admin Aside Menu Yetkilendirme Kontrol Fonksiyonları> ###
      function isDbAsidePermissions($moduleName=""){
          $_isPermissions = false;
          if(isDbAllowedViewModule($moduleName)){ $_isPermissions = true; }
          if(isDbAllowedListModule($moduleName)){ $_isPermissions = true; }
          if(isDbAllowedWriteModule($moduleName)){ $_isPermissions = true; }
          if(isDbAllowedUpdateModule($moduleName)){ $_isPermissions = true; }
          if(isDbAllowedDeleteModule($moduleName)){ $_isPermissions = true; }
          if(isDbAdminViewModule($moduleName)){ $_isPermissions = true; }
          return $_isPermissions;
      }
