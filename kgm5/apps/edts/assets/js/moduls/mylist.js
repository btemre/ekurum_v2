...
var KTDurusmalarListServerSide = function () {
	...
	var handleFilterSubmit = () => {
        ...
        filterData.dText = srcSearchText.value;
        // filterData.dIslem = srcIslem.value;
        filterData.dEsasNo = srcEsasno.value;
        filterData.dTarafBilgisi = srcTarafBilgisi.value;
        filterData.dTutanak = srcDtutanak.value;
