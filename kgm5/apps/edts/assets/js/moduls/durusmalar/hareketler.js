...
var KTCezalarMHareketlerServerSide = function () {
	...
	/*	$('#kt_content_durusmalar_hareketler_list thead tr')
				.clone(true)
				.addClass('filters')
				.appendTo('#kt_content_durusmalar_hareketler_list thead');		
		*/
        ...
        dtcezakayitmh = $("#kt_content_durusmalar_hareketler_list").DataTable({
            ...
            //stateSave: true,
            ajax: {
                url: baseUrlHost+"/apps/edts/durusmalar/api_hareketlerlist",
				method: 'POST',
				//dataType: 'json',
    ...
    var exportButtons = () => {
        ...
        var buttons = new $.fn.dataTable.Buttons(dtcezakayitmh, {
            buttons: [
                {
                    extend: 'copyHtml5',
                    title: documentTitle
        ...
        const exportButtonsEl = document.querySelectorAll('#kt_datatable_example_1_export_menu [data-kt-export]');
