...
if ($alertlogin) {
    ...
    ?>
        <script>
            ...
            Uygulama Beta Aşamasında Olduğu İçin Hataları Sistem Yöneticilerine veya <a href="https://ekurum.hipporello.net/desk" target="_blank"><span class="badge badge-info">Yardım Masasından</span></a> Bildiriniz.`,
                icon: "success",
                buttonsStyling: false,
