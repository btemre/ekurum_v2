    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-6 mb-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-500">Çöp Kutusu</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->

            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">EDTS | Duruşmalar Çöp Kutusu</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
        <!--begin::Actions-->
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <?php if (isDbAllowedWriteModule("durusmalar")) { ?>
                ...
                <a href="#" class="btn btn-sm fw-bold btn-primary d-none" data-bs-toggle="modal" data-bs-target="#kt_modal_new_durusmalar_manuel">Yeni Kayıt</a>
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 mb-md-5 mb-xl-10">
                ...
                <div class="card px-2">
                    ...
                    <div class="card-header border-0 pt-1 px-3">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                                ...
                                <!--end::Svg Icon-->
                                <input type="text" data-kt-dosc-durusmalar-update-table-filter="search" id="searchText" class="form-control form-control-solid min-w-350px ps-15" placeholder="Ara:" />
                            ...
                            <div class="d-flex justify-content-end" data-kt-dosc-durusmalar-update-table-toolbar="base">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
                                    ...
                                    <div class="px-7 py-5" data-kt-durusmalar-update-table-filter="form">
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                                            <label class="form-label fs-6 fw-bold">Memur:</label>
                                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Lütfen Seçiniz" data-allow-clear="true" data-hide-search="true" data-kt-durusmalar-update-table-filter="filterMemur" id="filterMemurSelect">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                                        <label class="form-label fs-6 fw-bold">Avukat:</label>
                    ...
                    <div class="card-body py-1 px-1" id="durusmalar_content_list">
                        ...
                        <!--begin::Datatable-->
                        <table id="kt_content_archive_durusmalar_list" class="table align-middle table-row-dashed table-striped min-h-400px fs-6 gy-5">
                            <thead>
