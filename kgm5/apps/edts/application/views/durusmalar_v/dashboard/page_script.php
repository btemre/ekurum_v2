...
<script src="<?php echo base_url('assets/js/moduls/dashboard/durusmalar/update.js'); ?>?v=<?php echo time(); ?>"></script>
...
document.addEventListener("DOMContentLoaded", function() {
    if (document.getElementById("ai_capacity_forecast_text")) AiService.requestCapacityForecast(false, true);
});
</script>
