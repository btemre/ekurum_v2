...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">EDTS | Duruşmalarım</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
        <!--begin::Actions-->
        ...
        <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
            ...
            <form method="POST" action="#" id="kt_modal_list_dosya_filter_form">
                ...
                <div class="card-body">
                    ...
                    <!--begin:Action-->
                    <div class="d-flex align-items-center">
                        <button id="kt_modal_durusmalar_list_ara_submit" type="submit" class="btn btn-primary me-5" data-kt-dosc-durusmalar-update-table-search="search">Ara</button>
                        <a id="kt_horizontal_search_advanced_link" class="btn btn-link" data-bs-toggle="collapse" href="#kt_durusma_advanced_search_form">Detaylı Arama</a>
                    </div>
                    <!--end:Action-->
                    </div>
                    <!--end::Compact form-->
                    ...
                    <div class="row g-8 mb-1">
                        ...
                        <div class="col-md fv-row">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <div class="overflow-hidden flex-grow-1">
                                    <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Seçiniz.." name="dlara_taraf" id="dlara_taraf">
                        ...
                        <div class="col-md fv-row">
                            ...
                            <div class="input-group flex-nowrap">
                                <span class="input-group-text"><i class="bi bi-person-workspace fs-3"></i></span>
                                <div class="overflow-hidden flex-grow-1">
                                    <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Seçiniz.." name="dlara_dtakip" id="dlara_dtakip">
                                        <option value="-1">Seçiniz..</option>
            ...
            <!--end::Search-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--begin::Tarih-->
                            <div class="d-flex align-items-center position-relative justify-content my-2 mt-3 mb-3 me-md-2 min-w-350px">
                            ...
                            <div class="d-flex align-items-center position-relative justify-content my-2 mt-3 mb-3 me-md-2 min-w-500px">
                                <form method="POST" action="">
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon2">Duruşma Aralığı:</span>
                                        <input class="form-control input-group py-2" placeholder="Duruşma Aralığı Seçin" id="kt_table_durusmalar2_datein" aria-describedby="basic-addon2" />
                                    </div>
                                </form>
                            </div>
                            <!--end::Tarih-->
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5 px-3">
                            ...
                            <!--begin::Toolbar-->
                            <div class="d-flex justify-content-end" data-kt-dosc-durusmalar-update-table-toolbar="base">
                                <!--begin::Filter-->
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
                                    ...
                                    <div class="px-7 py-5" data-kt-durusmalar-update-table-filter="form">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Lütfen Seçiniz" data-allow-clear="true" data-hide-search="true" data-kt-durusmalar-update-table-filter="filterAvukat" id="filterAvukatSelect">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Lütfen Seçiniz" data-allow-clear="true" data-hide-search="true" data-kt-durusmalar-update-table-filter="filterIslem" id="filterIslemSelect">
                                                <option value="-1" selected>Hepsi</option>
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="reset" class="btn btn-light btn-active-light-primary me-2" data-kt-menu-dismiss="true" data-kt-dosc-durusmalar-update-table-filter="reset">Sıfırla</button>
                                            <button type="submit" class="btn btn-primary" data-kt-menu-dismiss="true" data-kt-dosc-durusmalar-update-table-filter="filter" name="filtreleButton" id="filtreleButton">Filtrele</button>
                                        </div>
                                        <!--end::Actions-->
                                    </div>
                                    <!--end::Content-->
