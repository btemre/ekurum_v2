    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-6 mb-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-500">Yeni Statü</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->

            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Yeni Statü Ekle</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
        <!--begin::Actions-->
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 mb-md-5 mb-xl-10">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-dark">Yeni Statü Ekle</span>
                                <span class="text-muted mt-1 fw-bold fs-7">Formu Doldurup Yeni Kullanıcı Statüsü Ekleyebilirsiniz</span>
                            </h3>
                        </div>
                        <!--begin::Card title-->
                        <!--begin::Card toolbar-->
                    ...
                    <div class="card-px-0 pt-0">
                        <form action="<?php echo base_url('userstatus/save'); ?>" method="POST" name="new_usergroup">
                            <div class="py-5">
                                <div class="rounded border p-0">
                                    <div class="mb-10 p-1">
                                        <label class="form-label">Statü Adı:</label>
                                        <input type="text" class="form-control" placeholder="Statü adını yazınız" name="name" value="<?php echo isset($form_error) ? set_value("name") : ""; ?>" />
