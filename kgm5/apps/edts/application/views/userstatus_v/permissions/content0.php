...
<div class="toolbar" id="kt_toolbar">
  ...
  <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
      <!--begin::Title-->
      <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1"><?php echo $item->us_name; ?> - Grup Yetkilendirme Formu</h1>
      <!--begin::Separator-->
      <span class="h-20px border-1 border-gray-200 border-start ms-3 mx-2 me-1"></span>
      <!--end::Separator-->
      <!--begin::Description-->
      <!--span class="text-muted fs-7 fw-bold mt-2">#Kullanıcı Statüleri</span-->
      <!--end::Description-->
      <!--end::Title-->
      <!--begin::Breadcrumb-->
      <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">Kullanıcı Ayarları</li>
        <!--end::Item-->
        <!--begin::Item-->
        ...
        <li class="breadcrumb-item text-muted">
          <a href="<?php echo base_url("userstatus"); ?>" class="text-muted text-hover-primary">Kullanıcı Statüleri</a>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-dark"><?php echo $item->us_name; ?> - Yetkilendirme Yönetimi</li>
        <!--end::Item-->
      </ul>
      <!--end::Breadcrumb-->
    ...
    <div class="d-flex align-items-center gap-2 gap-lg-3">
        <!-- CONTENT BLOGUNUN SAG UST KOSESINDE FILTRELEME EKLEME CIKARMA BUTONLARI KONULABILIR -->
      ...
      <div class="card">
        ...
        <div class="card-px-0 pt-0">
          ...
          <div class="table-responsive">
            ...
            <!--begin::Table-->
            <table class="table table-hover table-sriped align-middle table-row-bordered fs-7 gy-5" id="kt_userstatus_permissions_table">
              <!--begin::Table head-->
              <thead>
                <!--begin::Table row-->
                ...
                <tr>
                  ...
                  <td>
                    <label class="form-check form-switch form-check-custom form-check-solid">
  										<input
                            name="permissions[<?php echo $controllerB->code; ?>][adminr]"
                            class="form-check-input h-25px w-35px"
                            type="checkbox"
                            <?php echo ($controller->sp_adminr) ? "checked" : ""; ?>
                            />
  									</label>
                  </td>
                  <td>
                    <label class="form-check form-switch form-check-custom form-check-solid">
  										<input
                            name="permissions[<?php echo $controllerB->code; ?>][list]"
                            class="form-check-input h-25px w-35px"
                            type="checkbox"
                            <?php echo ($controller->sp_list) ? "checked" : ""; ?>
                            />
  									</label>
                  </td>
                  <td>
                    <label class="form-check form-switch form-check-custom form-check-solid">
  										<input
                            name="permissions[<?php echo $controllerB->code; ?>][write]"
                            class="form-check-input h-25px w-35px"
                            type="checkbox"
                            <?php echo ($controller->sp_write) ? "checked" : ""; ?>
                            />
  									</label>
                  </td>
                  <td>
                    <label class="form-check form-switch form-check-custom form-check-solid">
  										<input
                            name="permissions[<?php echo $controllerB->code; ?>][update]"
                            class="form-check-input h-25px w-35px"
                            type="checkbox"
                            <?php echo ($controller->sp_update) ? "checked" : ""; ?>
                            />
  									</label>
                  </td>
                  <td>
                    <label class="form-check form-switch form-check-custom form-check-solid">
  										<input
                            name="permissions[<?php echo $controllerB->code; ?>][delete]"
                            class="form-check-input h-25px w-35px"
                            type="checkbox"
                            <?php echo ($controller->sp_delete) ? "checked" : ""; ?>
                            />
  									</label>
                  </td>
                  <td class="text-end">
                    <label class="form-check form-switch form-check-custom form-check-solid">
  										<input
                            name="permissions[<?php echo $controllerB->code; ?>][read]"
                            class="form-check-input h-25px w-35px"
                            type="checkbox"
                            <?php echo ($controller->sp_read) ? "checked" : ""; ?>
                            />
  									</label>
                  </td>
                </tr>
