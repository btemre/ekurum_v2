    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-6 mb-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-500">Yeni Kullanıcı</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->

            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Yeni Kullanıcı Ekleme</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
        <!--begin::Actions-->
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 mb-md-5 mb-xl-10">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-dark">Yeni Kullanıcı Ekle</span>
                                <span class="text-muted mt-1 fw-bold fs-7">Formu Doldurup Yeni Kullanıcı Ekleyebilirsiniz</span>
                            </h3>
                        </div>
                        <!--begin::Card title-->
                        <!--begin::Card toolbar-->
                    ...
                    <div class="card-body px-2 pt-0">
                        <form action="<?php echo base_url('users/save'); ?>" novalidate="novalidate" method="POST" name="new_users" id="kt_new_form">
                            <div class="py-5">
                                <div class="rounded border p-0">
                                        ...
                                        <select class="form-control" data-kt-select2="true" data-placeholder="Lütfen Birim Seçiniz" data-allow-clear="true" name="units" id="units">
                                            ...
                                            <?php if (isset($unitList)) { ?>
                                                <?php foreach ($unitList as $unit) { ?>
                                                    <option value="<?php echo @$unit->ub_id; ?>"><?php echo @$unit->ub_title; ?></option>
                                                <?php } ?>
                                            <?php } ?>
                                        </select>
                                        ...
                                        <select class="form-control" data-kt-select2="true" data-placeholder="Lütfen Statü Seçiniz" data-allow-clear="true" name="status" id="status">
                                            ...
                                            <?php if (isset($statuList)) { ?>
                                                <?php foreach ($statuList as $statu) { ?>
                                                    <option value="<?php echo @$statu->us_id; ?>"><?php echo @$statu->us_name; ?></option>
                                                <?php } ?>
                                            <?php } ?>
                                        </select>
                                        <?php if (isset($form_error)) { ?>
                                        ...
                                        <select class="form-control" data-kt-select2="true" data-placeholder="Lütfen İstasyon Seçiniz" data-allow-clear="true" name="istasyon" id="istasyon">
                                            ...
                                            <?php if (isset($istasyonList)) { ?>
                                                <?php foreach ($istasyonList as $istasyon) { ?>
                                                    <option value="<?php echo @$istasyon->kdi_id; ?>"><?php echo @$istasyon->kdi_isim; ?></option>
                                                <?php } ?>
                                            <?php } ?>
                                        </select>
                                        <?php if (isset($form_error)) { ?>
                                    ...
                                    <div class="fv-row mb-10 p-1">
                                        ...
                                        <input type="text" class="form-control" placeholder="Adını yazınız" name="name" value="<?php echo isset($form_error) ? set_value("name") : ""; ?>" />
                                        <?php if (isset($form_error)) { ?>
                                            <div class="fv-plugins-message-container invalid-feedback">
                                    ...
                                    <div class="fv-row mb-10 p-1">
                                        ...
                                        <input type="text" class="form-control" placeholder="İkinci adını yazınız" name="lastname" value="<?php echo isset($form_error) ? set_value("lastname") : ""; ?>" />
                                        <?php if (isset($form_error)) { ?>
                                            <div class="fv-plugins-message-container invalid-feedback">
                                    ...
                                    <div class="fv-row mb-10 p-1">
                                        ...
                                        <input type="text" class="form-control" placeholder="Soyadını yazınız" name="surname" value="<?php echo isset($form_error) ? set_value("surname") : ""; ?>" />
                                        <?php if (isset($form_error)) { ?>
                                            <div class="fv-plugins-message-container invalid-feedback">
                                    ...
                                    <div class="fv-row mb-10 p-1">
                                        ...
                                        <select class="form-control"  data-kt-select2="true" data-placeholder="Lütfen Cinsiyet Seçiniz" data-allow-clear="true" name="cinsiyet" id="cinsiyet">
                                            <option></option>
                                            <?php if (isset($cinsiyetList)) { ?>
                                                <?php foreach ($cinsiyetList as $k=>$v) { ?>
                                    ...
                                    <div class="fv-row mb-10 p-1">
                                        ...
                                        <input type="email" class="form-control" placeholder="Email adresini yazınız" name="email" id="email" value="<?php echo isset($form_error) ? set_value("email") : ""; ?>" />
                                        <?php if (isset($form_error)) { ?>
                                            <div class="fv-plugins-message-container invalid-feedback">
                                    ...
                                    <div class="fv-row mb-10 p-1">
                                        ...
                                        <input class="form-control" placeholder="Kullanıcı adınızı yazınız" type="text" name="username" id="username" value="<?php echo isset($form_error) ? set_value("username") : ""; ?>" />
                                        <?php if (isset($form_error)) { ?>
                                            <div class="fv-plugins-message-container invalid-feedback">
                                    ...
                                    <div class="mb-1 p-1">
                                        ...
                                        <!--end::Primary button-->
                                        <!--begin::Primary button-->
                                        <button type="submit" class="btn btn-sm btn-success" id="kt_new_form_submit">
