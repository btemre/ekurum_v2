...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <a href="<?php echo base_url("usergroup/permissions/{$item->ug_id}"); ?>" class="btn btn-sm btn-primary">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-dark"><?php echo $item->ug_name; ?> - Yetkilendirme Formu</span>
                                <span class="text-muted mt-1 fw-bold fs-7">Kullanıcı Gruplarıyla İlgili Yetkilendirme Güncellemeleri Yapabilirsiniz</span>
                            </h3>
                        </div>
                        <!--begin::Card title-->
                        <!--begin::Card toolbar-->
                    ...
                    <div class="card-body px-1 pt-0">
                        ...
                        <?php } else { ?>
                            <div class="table-responsive">
                                <form action="<?php echo base_url("usergroup/update_permissions/$item->ug_id"); ?>" method="POST">
                                    <!--begin::Table-->
