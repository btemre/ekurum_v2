...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0"><?php echo $item->ub_title; ?> - Düzenleme</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
        <!--begin::Actions-->
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 mb-md-5 mb-xl-10">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-dark"><?php echo $item->ub_title; ?> - Düzenleme</span>
                                <span class="text-muted mt-1 fw-bold fs-7">Formu Doldurup Birimi Güncelleyebilirsiniz.</span>
                            </h3>
                        </div>
                        <!--begin::Card title-->
                        <!--begin::Card toolbar-->
                    ...
                    <div class="card-px-0 pt-0">
                        <form action="<?php echo base_url("units/update/{$item->ub_id}"); ?>" method="POST" name="new_units">
                            <div class="py-5">
                                <div class="rounded border p-0">
                                    <div class="mb-10 p-2">
                                        <label class="form-label">Birim Adı:</label>
                                        <input type="text" class="form-control" placeholder="Birim adını giriniz" maxlength="255" name="name" value="<?php echo isset($form_error) ? set_value("name") : $item->ub_title; ?>" />
                                    ...
                                    <div class="mb-10 p-2">
                                        ...
                                        <input type="text" class="form-control" placeholder="Kısaltılmış birim adını giriniz" name="short_name" maxlength="10" value="<?php echo isset($form_error) ? set_value("shor_name") : $item->ub_short_title; ?>" />
                                        <?php if (isset($form_error)) { ?>
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="short_name"><?php echo @form_error("short_name"); ?></div>
                                            </div>
                                        <?php } ?>
                                    </div>
                                    ...
                                    <div class="mb-10 p-2">
                                        <label class="form-label">Birim Açıklaması:</label>
                                        <textarea class="form-control" name="description" style="height: 100px"><?php echo isset($form_error) ? set_value("description") : $item->ub_description; ?></textarea>
                                        <?php if (isset($form_error)) { ?>
                                            <div class="fv-plugins-message-container invalid-feedback">
