...
// Kullanıcı başına günlük AI istek limiti (varsayılan; r8t_edts_ai_user_quota tablosunda kullanıcı kaydı varsa o kullanılır)
$config['ai_rate_limit_per_user']   = 100;
$config['ai_rate_limit_per_tenant'] = 5000;
$config['ai_user_quota_table']      = 'r8t_edts_ai_user_quota';  // Kullanıcı bazlı kota tablosu (boş bırakılırsa sadece ai_rate_limit_per_user kullanılır)
