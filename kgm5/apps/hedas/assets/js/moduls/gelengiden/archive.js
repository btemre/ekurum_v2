	...
	/*	$('#kt_content_gelengiden_list thead tr')
		...
		*/
        ...
        dt = $("#kt_content_gelengiden_list").DataTable({
            ...
            //stateSave: true,
            ajax: {
                url: baseUrlHost+"/apps/hedas/gelengiden/api_ejectlist",
				method: 'POST',
				//dataType: 'json',
                    ...
                    render: function (data, type, row) {
						...
						<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-1" data-kt-menu="true">
							...
							<div class="menu-item px-1">
								<a href="#" class="menu-link px-3 popup-btn ggCopButton" data-id="`+row._id+`" id="arsivle`+row._id+`" onclick="KTGelenGidenListServerSide.geriAlModal('`+row._id+`');">Geri Al
								</a>
							</div>
							<!--end::Menu item-->
						</div>
