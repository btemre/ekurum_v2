...
var KTModalEditDosya = function () {
    ...
    var initMahkemeDatatable = function () {
        ...
        .on( 'select', function ( e, dt, type, indexes ) {
			...
			editMahkemeData = {
				...
				dmMahkeme: rowData._mahkemeEdit,
	...
	const handleEditMahkemeForm = () => {
		...
		inpMahkeme.value = editMahkemeData.dmMahkeme;
				...
				validatorMahkeme.validate().then(function (status) {
					...
					if (status == 'Valid') {
						...
						setTimeout(function() {
							...
							editMahkemeData.dmMahkeme = inpMahkeme.value;
							editMahkemeData.dmAciklama = inpMahkemeAciklama.value;
							
							// Show success message. For more info check the plugin's official documentation: https://sweetalert2.github.io/
							Swal.fire({
								text: "Mahkeme Bilgisi Güncellenecek!",
								icon: "info",
								buttonsStyling: false,
								confirmButtonText: "Tamam",
								customClass: {
				...
				validatorMahkeme.validate().then(function (status) {
					...
					if (status == 'Valid') {
						...
						setTimeout(function() {
							...
							// Show success message. For more info check the plugin's official documentation: https://sweetalert2.github.io/
							Swal.fire({
								text: "Dosyaya Yeni Mahkeme Bilgisi Eklenecek!",
								icon: "info",
								buttonsStyling: false,
								confirmButtonText: "Tamam",
								customClass: {
	...
	return {
		populate: function (){
			...
			inpMahkeme = mahkemeform.querySelector('[name="edt_dm_mahkeme"]');
