		<!--begin::Modal - Cezaİptal Ekle-->
		<div class="modal fade" id="kt_modal_new_cezaiptal" tabindex="-1" aria-hidden="true">
			<!--begin::Modal dialog-->
			<div class="modal-dialog modal-dialog-centered mw-1000px">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
						<!--begin:Form-->
						<form id="kt_modal_new_cezaiptal_form" class="form" action="#">
							<!--begin::Heading-->
							<div class="mb-13 text-center">
								<!--begin::Title-->
								<h1 class="mb-3">Yeni Ceza İptal Başvurusu</h1>
								<!--end::Title-->
								<!--begin::Description-->
							...
							<div class="row g-4 mb-4"> 
								...
								<div class="col-md-4 fv-row">
									...
									<input type="number" class="form-control form-control-solid" value="<?= $dosyanootomatik[0]->dosyasira;?>" placeholder="Dosya No" name="ci_dosyano" />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
							...
							<div class="row g-4 mb-4">
								...
								<div class="col-md-4 fv-row">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" placeholder="Tarih Seç" name="ci_acilistarihi" />
										<!--end::Datepicker-->
									</div>
								</div>
								<div class="col-md-8 fv-row">
							...
							<div class="row g-4 mb-4">
								...
								<div class="col-md-4 fv-row">
									...
									<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Seçiniz.." name="ci_evrakdurum">
							...
							<div class="row g-4 mb-4">
								...
								<div class="col-md fv-row">
									...
									<div class="pt-3">
										...
										<span class="text-info" id="kt_cezaiptal_tags_suggests">
							...
							<div class="text-center">
								<button type="reset" id="kt_modal_new_cezaiptal_cancel" class="btn btn-danger btn-hover-rotate-end me-3">
									<i class="bi bi-x-circle fs-4 me-2"></i>Vazgeç
								</button>
								<button type="submit" id="kt_modal_new_cezaiptal_submit" class="btn btn-primary btn-hover-scale">
