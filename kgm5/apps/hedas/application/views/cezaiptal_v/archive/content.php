        ...
        <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
            ...
            <div class="row g-5 g-xl-10">
                ...
                <div class="card-body py-1 px-1" id="cezaiptal_content_list">
                    ...
                    <!--begin::Datatable-->
                    <table id="kt_content_cezaiptal_list" class="table align-middle table-row-dashed min-h-400px fs-6 gy-5">
                    <thead>
                        ...
                        <th class="min-w-125px" data-priority="1">İtiraz Eden</th>
                        <th>Dava Konusu</th>
                        <th>Mahkeme</th>
                        <th>Esas No</th>
                        <th>Karar No</th>
                        ...
                        <th class="min-w-600px min-h-50px">&nbsp;</th>
