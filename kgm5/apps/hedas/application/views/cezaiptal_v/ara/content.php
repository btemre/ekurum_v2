    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-6 mb-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600 fw-bold lh-1">Ceza İptal</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->

            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">HEDAS | Ceza Iptal Başvuruları  </h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
        ...
        <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
            ...
            <!--end::Search-->
                    ...
                    <div class="card-body py-1 px-1" id="gelengiden_content_list">
                        ...
                        <table id="cezaiptal" class="table nowrap table-striped align-middle">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                
                                    <th>Açılış Tarih</th>
                                    <th class="min-w-12px">Ceza Konusu</th>
                                    <th class="min-w-75px">Kurum Dosya No</th>
                                    <th class="min-w-125px">İtiraz Eden</th>
                                    <th>Dava Konusu</th>
                                    <th>Mahkeme</th>                                    
                                    <th>Esas No</th>
                                    <th>Karar Tarihi</th>                                    
                            ...
                            <?php foreach ($cezaiptaltum as $cezaiptaltum ) { ?>
                                <tr>
                                <td> <?=TimeToDateFormat($cezaiptaltum->ci_acilistarih,"d-m-Y H:i");?></td>
                                <td> <?=etAyracsizYazdir(@$cezaiptaltum->ci_cezakonu); ?></td>
                                <td> <?=@$cezaiptaltum->ci_kurumdosyano; ?></td>
                                <td> <?=etAyracsizYazdir(@$cezaiptaltum->ci_itirazeden); ?></td>
                                <td> <?=etAyracsizYazdir(@$cezaiptaltum->ci_davakonu); ?></td>
                                <td> <?=etAyracsizYazdir(@$cezaiptaltum->ci_mahkeme); ?></td>
                                <td> <?=@$cezaiptaltum->ci_esasno; ?></td>
                                <td> <?=TimeToDateFormat($cezaiptaltum->ci_karartarih,"d-m-Y H:i");?></td>
                                <td> <?=etAyracsizYazdir(@$cezaiptaltum->ci_plaka); ?></td>
                                <td> <?=@$cezaiptaltum->ci_cezaserino; ?></td>
                                <td> <?=ciDurumYazdir($cezaiptaltum->ci_evrakdurum) ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
