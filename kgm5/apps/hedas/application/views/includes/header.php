            ...
            <div class="app-navbar flex-shrink-0">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('<?php echo base_url("assets/media/misc/menu-header-bg.jpg"); ?>')">
                            ...
                            <h3 class="text-white fw-semibold px-9 mt-10 mb-6">Bildirimler
                                <span class="fs-8 opacity-75 ps-3">0 bildirim</span>
                            </h3>
                            <!--end::Title-->
                            <!--begin::Tabs-->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="kt_topbar_notifications_alert" role="tabpanel">
                                ...
                                <div class="scroll-y mh-325px my-5 px-8">
                                    ...
                                    <div class="d-flex flex-stack py-4 d-none">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Title-->
                                            <div class="mb-0 me-2">
                                                <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Uyarı 1</a>
                                                <div class="text-gray-400 fs-7">1. Uyarı Açıklaması</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8">1 saat</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
                                </div>
                                ...
                                <div class="py-3 text-center border-top">
                                    <a href="#" class="btn btn-color-gray-600 btn-active-color-primary">Hepsini Göster
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="pt-10 pb-0">
                                        ...
                                        <div class="text-center mt-5 mb-9 d-none">
                                            <a href="#" class="btn btn-sm btn-primary px-6" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Güncelle</a>
                                        </div>
                                        <!--end::Action-->
                                    </div>
                                    <!--end::Section-->
                                ...
                                <div class="scroll-y mh-325px my-5 px-8">
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--end::Code-->
                                            <!--begin::Title-->
                                            <a href="#" class="text-gray-800 text-hover-primary fw-semibold">Yakında Eklenecek</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8">Gelecekte</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
                                </div>
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <!--end::Menu item-->
                        <?php if (isDbAllowedListModule("notesreminders")) { ?>
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
