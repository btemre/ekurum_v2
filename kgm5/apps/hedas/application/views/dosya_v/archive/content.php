...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Çöp Kutusu</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
        <!--begin::Actions-->
            ...
            <div class="row g-5 g-xl-10">
                ...
                <div class="card-header border-0 pt-1 px-3">
                    ...
                    <div class="d-flex justify-content-end d-none" data-kt-docs-table-toolbar="base">
                        ...
                        <!--end::Separator-->
                        <!--begin::Content-->
                        <div class="px-7 py-5 hover-scroll" data-kt-dosya-table-filter="form">
                            <!--begin::Input group-->
                            <div class="mb-3">
                            <label class="form-label fs-6 fw-bold">Davacı:</label>
                            <input class="form-control form-control-solid fw-bolder" data-kt-dosya-table-filter="dFilterDavaci" id="dFilterDavaci" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-3">
                            <label class="form-label fs-6 fw-bold">Davalı:</label>
                            <input class="form-control form-control-solid fw-bolder" data-kt-dosya-table-filter="dFilterDavali" id="dFilterDavali" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-3">
                            <label class="form-label fs-6 fw-bold">Dava Konusu:</label>
                            <input class="form-control form-control-solid fw-bolder" data-kt-dosya-table-filter="dFilterDavaKonusu" id="dFilterDavaKonusu" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-3">
                            <label class="form-label fs-6 fw-bold">Konu Açıklaması:</label>
                            <input class="form-control form-control-solid fw-bolder" data-kt-dosya-table-filter="dFilterDavaKonuAciklama" id="dFilterDavaKonuAciklama" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-3">
                            <label class="form-label fs-6 fw-bold">Mahkeme:</label>
                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Lütfen Seçiniz" data-allow-clear="true" data-hide-search="true" data-kt-dosya-table-filter="dFilterMahkeme" id="dFilterMahkeme">
                            ...
                            <!--begin::Input group-->
                            <div class="mb-3">
                            <label class="form-label fs-6 fw-bold">Esas No:</label>
                            <input class="form-control form-control-solid fw-bolder" data-kt-dosya-table-filter="dFilterEsasNo" id="dFilterEsasNo" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-3">
                            <label class="form-label fs-6 fw-bold">Kurum No:</label>
                            <input class="form-control form-control-solid fw-bolder" data-kt-dosya-table-filter="dFilterKurumNo" id="dFilterKurumNo" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-3">
                            <label class="form-label fs-6 fw-bold">İcra:</label>
                            <input class="form-control form-control-solid fw-bolder" data-kt-dosya-table-filter="dFilterIcra" id="dFilterIcra" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-3">
                            <label class="form-label fs-6 fw-bold">Mevki/Plaka:</label>
                            <input class="form-control form-control-solid fw-bolder" data-kt-dosya-table-filter="dFilterMevkiPlaka" id="dFilterMevkiPlaka" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-3">
                            <label class="form-label fs-6 fw-bold">İstinaf Kabul:</label>
                            <input class="form-control form-control-solid fw-bolder" data-kt-dosya-table-filter="dFilterIstinafKabul" id="dFilterIstinafRed" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-3">
                            <label class="form-label fs-6 fw-bold">Yargıtay Bozma:</label>
                            <input class="form-control form-control-solid fw-bolder" data-kt-dosya-table-filter="dFilterBozmaIlami" id="dFilterBozmaIlami" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-3">
                            <label class="form-label fs-6 fw-bold">Yargıtay Onama:</label>
                            <input class="form-control form-control-solid fw-bolder" data-kt-dosya-table-filter="dFilterOnamaIlami" id="dFilterOnamaIlami" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-3">
                            ...
                            <div class="mb-10">
                            <label class="form-label fs-6 fw-bold">Davacı:</label>
                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Lütfen Seçiniz" data-allow-clear="true" data-hide-search="true" data-kt-dosya-table-filter="filterDurum" id="filterDurumSelect">
                                <option value="-1" selected>Hepsi</option>
                ...
                <div class="card-body py-1 px-1" id="dosya_content_list">
                    ...
                    <!--begin::Datatable-->
                    <table id="kt_content_dosya_list" class="table align-middle table-row-dashed min-h-400px fs-6 gy-5">
                    <thead>
