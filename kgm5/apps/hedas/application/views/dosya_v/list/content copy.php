...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div class="row g-5 g-xl-10">
        ...
        <div class="card-header border-0 pt-1 px-3">
            ...
            <form method="POST" action="#" id="kt_modal_list_dosya_filter_form">
                ...
                <div class="card-body">
                    ...
                    <div class="position-relative w-md-400px me-md-2">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" class="form-control form-control-solid ps-10" name="dlara_dosyano" value="" placeholder="Kurum Dosya No" />
                    </div>
                    <!--end::Input group-->
                    <!--begin:Action-->
                    <div class="d-flex align-items-center">
                    ...
                    <div class="row g-8 mb-1">
                        <!--begin::Col-->
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">Mahkeme</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_mahkeme" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">Esas No</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_esasno" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">Davacı</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_davaci" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">Davalı</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_davali" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">Dava Konusu</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_davakonusu" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">Dava Açıklama</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_konuaciklama" />
                        </div>
                    </div>
                    <div class="row g-8 mb-1">
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">Mevki</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_mevki" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">İcra No</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_icrano" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">İcra</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_icra" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">İstinaf Kabul</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_istinafkabul" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">İstinaf Red</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_istinafred" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">Onama İlamı</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_onamailami" />
                        </div>
                    </div>
                    <div class="row g-8 mb-2">
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">Bozma İlamı</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_bozmailami" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">İstinaf Başvuru</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_istinaf" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">Temyiz Başvuru</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_temyiz" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">Miras Bel. Tapu Kay..</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_mirascilik" />
                        </div>
                        <div class="col-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">Etiket</label>
                        <input type="text" class="form-control form-control form-control-solid" name="dlara_tags" />
                        </div>
                        <div class="col-md-2">
            ...
            <!--begin::Toolbar-->
            <div class="d-flex justify-content-end d-none" data-kt-docs-table-toolbar="base">
        ...
        <div class="card-body py-1 px-1" id="dosya_content_list">
            ...
            <thead>
                ...
                <th class="min-w-100px" data-priority="1">Mevki Plaka</th>
                <th>Arşiv No</th>
                <th data-priority="1">İcra No</th>
                <th class="min-w-200px">Konu Açıklaması</th>
                <th class="min-w-200px">Proje</th>
                <th class="min-w-100px" data-priority="1">İcra</th>
                <th>Temyiz</th>
                ...
                <th data-priority="1">Mirasçılık</th>
                <th>İdari Alacağı</th>
