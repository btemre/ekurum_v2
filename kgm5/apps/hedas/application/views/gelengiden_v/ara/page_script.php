...
<!--<script src="<?php echo base_url('assets/js/moduls/gelengiden/list.js'); ?>"></script>
<script src="<?php echo base_url('assets/js/moduls/gelengiden/update.js'); ?>"></script>-->
