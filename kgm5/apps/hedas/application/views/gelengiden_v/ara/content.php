    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-6 mb-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600 fw-bold lh-1">Evraklar</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->

            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">HEDAS | Gelen Giden Evrak Listesi</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
        ...
        <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
            ...
            <!--end::Search-->
                    ...
                    <div class="card-body py-1 px-1" id="gelengiden_content_list">
                        ...
                        <table id="gelengiden" class="table nowrap table-striped align-middle">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                
                                    <th data-priority="1">İlgili</th>
                                    <th class="min-w-12px" data-priority="1">Açıklama</th>
                                    <th class="min-w-75px" data-priority="1">Sayı</th>
                                    <th class="min-w-125px" data-priority="1">Tarih</th>
                            ...
                            <?php foreach ($gelengidentum as $gelengidentum ) { ?>
                                <tr>
                                <td> <?=etAyracsizYazdir(@$gelengidentum->gg_kaynak); ?></td>
                                <td> <?=html_entity_decode($gelengidentum->gg_aciklama, ENT_QUOTES) ?></td>
                                <td> <?=@$gelengidentum->gg_sayi; ?></td>
                                <td> <?=TimeToDateFormat($gelengidentum->tarih2,"d-m-Y H:i");//date("d-m-Y", strtotime(@$gelengidentum->tarih)); ?></td>
                                <td> <?=ggKategoriYazdir($gelengidentum->gg_kategori) ?></td>
                                <td> <?=ggTurYazdir($gelengidentum->gg_tur) ?></td>
