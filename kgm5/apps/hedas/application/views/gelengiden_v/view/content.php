    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-6 mb-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-500">Gelen-Giden Evrak</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->

            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Evraklar</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
        <!--begin::Actions-->
        ...
        <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
            ...
            <div class="row g-5 g-xl-10">
                ...
                <div class="card-header border-0 pt-1 px-3">
                    ...
                    <div class="d-flex align-items-center position-relative justify-content my-2 mt-3 mb-3 min-w-350px">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control input-group py-2" placeholder="Çalışma Aralığı Seçin" id="kt_table_gelengiden_datein" aria-describedby="basic-addon1" />
                        </div>
                        </form>
                    </div>
                    <!--end::Tarih-->
                    ...
                    <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                        ...
                        <!--end::Separator-->
                        <!--begin::Content-->
                        <div class="px-7 py-5" data-kt-gelengiden-table-filter="form">
                            <!--begin::Input group-->
                            <div class="mb-10">
                            <label class="form-label fs-6 fw-bold">Evrak Türü:</label>
                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Lütfen Seçiniz" data-allow-clear="true" data-hide-search="true" data-kt-gelengiden-table-filter="filterTur" id="filterTurSelect">
                            ...
                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Lütfen Seçiniz" data-allow-clear="true" data-hide-search="true" data-kt-gelengiden-table-filter="filterKategori" id="filterKategoriSelect">
                                <option value="-1" selected>Hepsi</option>
                ...
                <div class="card-body py-1 px-1" id="gelengiden_content_list">
                    ...
                    <!--begin::Datatable-->
                    <table id="kt_content_gelengiden_list" class="table align-middle table-row-dashed table-striped min-h-400px fs-6 gy-5">
                    <thead>
