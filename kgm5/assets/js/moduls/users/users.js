...
var KTUsersList = function () {
    ...
    var initUserTable = function () {
		//console.log("initUserTable Function");
        // Set date data order
        ...
        tableRows.forEach(row => {
			...
			//console.log(row.innerText+" \n [timeCount:"+timeCount+"] - [timeFormat:"+timeFormat+"]");
			...
			//console.log("[realDate:"+realDate+"] - [joinedDate:"+joinedDate+"]");
        });
        ...
        datatable = $(table).DataTable({
            ...
            "lengthChange": true,
            "language": {
                "url": baseUrlHost+"/assets/js/moduls/users/DatatableTurkish.json"
            },
            /*"oLanguage": {
        ...
        datatable.on('draw', function () {
            ...
            //handleDeleteRows();
            //toggleToolbars();
			//console.log("datablo draw işlemi");
        });
    }
    ...
    var handleResetForm = () => {
        ...
        resetButton.addEventListener('click', function () {
            ...
            const filterForm = document.querySelector('[data-kt-user-table-filter="form"]');
            const selectOptions = filterForm.querySelectorAll('select');
			const searchTextbox = document.querySelector('[data-kt-user-table-filter="search"]');
